...
export function Welcome({ btnStart }) {
  ...
  return (
      <div className='init-form'>
        <p>Benvinguts !!!!</p>
        <p>Descripció del projecte</p>
        <p>Ja has arribat al teu primer lliurament de React! Una vegada tenint els conceptes clars de javascript, veuràs que <strong>amb l'ajuda de React, podràs fer de manera fàcil i ràpida aplicacions més potents del que podíem fer amb Javascript pla</strong> (vanilla Javascript).</p>
        ...
        <p><strong>Un/a client/a</strong> que té com a producte principal una web de gestió empresarial desenvolupada amb React, ens ha demanat que <strong>desenvolupem un tutorial, en el qual mitjançant dos botons els nous usuaris puguin avançar i retrocedir en els consells, modificant-se el text d'ajuda i la imatge de fons.</strong></p>
